...
exports.run = async(client, message, args) => { 
  ...
  if(!kanals) return message.channel.send('Kanal ayarlamam için bir kanal belirtmen gerekiyor. \nÖrnek: `!!seviye-log #kanal`')
